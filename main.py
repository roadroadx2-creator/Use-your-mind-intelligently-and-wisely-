...
if question13.lower().strip() in ["The door" , "the bell"] :
       correct_answers +=1
       print("correct!")
else:
       print("Wrong!")
...
if question14.lower().strip() =="a map" :
       correct_answers +=1
       print("correct!")
else:
       print("Wrong!")
...
if questionx7.lower().strip() in["light" ,"air"] :
       correct_answers +=1
       print("correct!")
else:
       print("Wrong!")
...
if questiony1.lower().strip() =="a map":
       correct_answers +=1
       print("correct!")
else:
       print("Wrong!")
...
if questiony6.lower().strip() in ["take goat", "Return alone" ,"Take wolf", "Take goat" , "Bring goat back", "Take cabbage", "Return alone" ]:
       correct_answers +=1
       print("correct!")
else:
       print("Wrong!")
